...
function updateVideo(){
    ...
    if(serverValue == "S1")
    {
        if(dayValue == "D1"){
            ...
            videoIframe.src = "https://filemoon.sx/e/jtn3qvmuukng";
        }
        else if(dayValue == "D9"){
            videoIframe.src = "https://filemoon.sx/e/buy1ej18idq0";
        }
        else if(dayValue == "D10"){
            videoIframe.src = "https://filemoon.sx/e/jskjnsbe6tda";
        }
        else if(dayValue == "D11"){
            videoIframe.src = "https://filemoon.sx/e/472gfp2xqun4";
        }
        else if(dayValue == "D12"){
            videoIframe.src = "https://filemoon.sx/d/omzz1qb3slmr";
        }
